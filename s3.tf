module "ml_feast_restricted_s3_bucket" {
 # source                  = "git@github.com:HBOCodeLabs/cloudops-terraform-aws-modules//s3?ref=master"
  bucket                  = local.ml_feast_s3_bucket_name
  acl                     = "private"
